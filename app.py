...
# Define CSS for Dark and Light Mode
LIGHT_MODE_CSS = """
    <style>
        body, .stApp {
        ...
        /* Assistant messages (AI response) */
        ...
        height: 100%;  /* Make it take the full column height */
        }
    </style>
"""
...
DARK_MODE_CSS = """
    <style>
        ...
        /* Force text color for all chat messages */
        .stChatMessage {
            color: white !important;
        }

        /* User messages */
        .stChatMessage[data-testid="stMessage"]:has(div[aria-label="user"]) {
        ...
        /* Assistant messages */
        .stChatMessage[data-testid="stMessage"]:has(div[aria-label="assistant"]) {
...
# Initialize night mode if not set
st.session_state["night_mode"] = st.session_state.get("night_mode", True)
